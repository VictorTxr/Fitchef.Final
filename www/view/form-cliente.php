...
<form class="form-horizontal" method="post" action="<?php echo $url; ?>/cliente/cadastrar">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="" name="telefone" type="text" placeholder="" class="form-control input-md">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="" name="cpf" type="text" placeholder="" class="form-control input-md">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="" name="endereco" type="text" placeholder="" class="form-control input-md">
